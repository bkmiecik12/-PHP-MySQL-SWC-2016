...
<head>
	...
	while($row = $res->fetch_array())
	{
		...
		$ask_rider = "SELECT riders.name,vastervik.sum FROM teams,riders,vastervik WHERE teams.team='$team' AND riders.team=teams.idteam AND vastervik.idrider=riders.idrider AND vastervik.number>0 ORDER BY number";
